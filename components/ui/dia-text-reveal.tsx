  ...
  return (
    <motion.span
      ...
      style={{
        ...
        color: "transparent",
        // Fix: en algunas versiones/config de Chrome, `color: transparent`
        // solo no basta para ocultar el glifo detrás de background-clip:text
        // (queda invisible o con antialiasing residual). Forzar el relleno
        // del texto por WebKit lo hace consistente entre navegadores.
